...
void LecteurVue::chargerDiaporama()
{
    ...
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "animal", "Mickey", "C:\\cartesDisney\\Disney_19.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "créature", "Mushu", "C:\\cartesDisney\\Disney_10.gif");
    _diaporama.push_back(imageACharger);
